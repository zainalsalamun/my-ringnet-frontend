...
export function PageHeader({ title, subtitle, actionHref, actionLabel, rightContent, action }: { title: string; subtitle: string; actionHref?: string; actionLabel?: string; rightContent?: ReactNode; action?: ReactNode }) {
  return (
    <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      {rightContent || action || (actionHref && actionLabel ? (
