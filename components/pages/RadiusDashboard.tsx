...
import { Activity, ArrowUpRight, CheckCircle2, Database, Network, Radio, RefreshCw, Router, Server, ShieldCheck, Users, Wifi } from "lucide-react";
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="p-5">
          ...
          {loading ? (
            ...
            <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50 p-8 text-center text-sm text-slate-500">
              Belum ada grup profil terdaftar.
            </div>
          ) : (
